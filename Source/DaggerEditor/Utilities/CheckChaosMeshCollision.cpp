...
namespace DaggerEditorUtilities
{

//////////////////////////////////////////////////////////////////////////

// returns true if the mesh has one or more degenerate triangles
bool CheckMeshDataForProblem(
	const Chaos::FTriangleMeshImplicitObject::ParticlesType& Particles,
	const Chaos::FTrimeshIndexBuffer& Elements
){
...
FAutoConsoleCommandWithWorldArgsAndOutputDevice GCheckChaosMeshCollisionCmd(
	TEXT("Dagger.CheckChaosMeshCollision"),
	TEXT("Usage:\n")
	TEXT("  Dagger.CheckChaosMeshCollision\n")
	TEXT("\n")
