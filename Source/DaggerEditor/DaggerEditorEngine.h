...
#include "DaggerEditorEngine.generated.h"
...
UCLASS()
class UDaggerEditorEngine : public UUnrealEdEngine
{
	GENERATED_BODY()

public:

	UDaggerEditorEngine(const FObjectInitializer& ObjectInitializer = FObjectInitializer::Get());
