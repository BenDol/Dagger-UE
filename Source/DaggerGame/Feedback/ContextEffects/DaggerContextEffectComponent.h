...
#include "DaggerContextEffectComponent.generated.h"
...
class DAGGERGAME_API UDaggerContextEffectComponent : public UActorComponent, public IDaggerContextEffectsInterface
{
	GENERATED_BODY()

public:	
	// Sets default values for this component's properties
	UDaggerContextEffectComponent();
...
public:
	...
	UPROPERTY(EditAnywhere)
	TSet<TSoftObjectPtr<UDaggerContextEffectsLibrary>> DefaultContextEffectsLibraries;

	UFUNCTION(BlueprintCallable)
	void UpdateEffectContexts(FGameplayTagContainer NewEffectContexts);

	UFUNCTION(BlueprintCallable)
	void UpdateLibraries(TSet<TSoftObjectPtr<UDaggerContextEffectsLibrary>> NewContextEffectsLibraries);
...
private:
	...
	UPROPERTY(Transient)
	TSet<TSoftObjectPtr<UDaggerContextEffectsLibrary>> CurrentContextEffectsLibraries;
