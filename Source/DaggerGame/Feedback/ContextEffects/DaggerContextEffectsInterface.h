...
#include "DaggerContextEffectsInterface.generated.h"
 ...
 */
 ...
 class DAGGERGAME_API UDaggerContextEffectsInterface : public UInterface
 {
	 GENERATED_BODY()

 };
 
 class DAGGERGAME_API IDaggerContextEffectsInterface : public IInterface
 {
	 GENERATED_BODY()
