...
#include "AnimNotify_DaggerContextEffects.generated.h"

/**
 *
 */
USTRUCT(BlueprintType)
struct DAGGERGAME_API FDaggerContextEffectAnimNotifyVFXSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct DAGGERGAME_API FDaggerContextEffectAnimNotifyAudioSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct DAGGERGAME_API FDaggerContextEffectAnimNotifyTraceSettings
{
	GENERATED_BODY()
 ...
 */
USTRUCT(BlueprintType)
struct DAGGERGAME_API FDaggerContextEffectAnimNotifyPreviewSettings
{
	GENERATED_BODY()
	...
	// Preview Library
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = Preview, meta = (AllowedClasses = "/Script/DaggerGame.DaggerContextEffectsLibrary"))
...
class DAGGERGAME_API UAnimNotify_DaggerContextEffects : public UAnimNotify
{
	GENERATED_BODY()

public:
	UAnimNotify_DaggerContextEffects();
	...
	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FDaggerContextEffectAnimNotifyVFXSettings VFXProperties;

	// Scale to spawn the particle system at
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "AnimNotify", meta = (ExposeOnSpawn = true))
	FDaggerContextEffectAnimNotifyAudioSettings AudioProperties;
	...
	FDaggerContextEffectAnimNotifyTraceSettings TraceProperties;
	...
	FDaggerContextEffectAnimNotifyPreviewSettings PreviewProperties;
#endif
