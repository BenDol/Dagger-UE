...
#include "Accolades/DaggerAccoladeDefinition.h"
#include "AsyncMixin.h"
#include "CommonUserWidget.h"
#include "GameFramework/GameplayMessageSubsystem.h"

#include "DaggerAccoladeHostWidget.generated.h"

class UObject;
class USoundBase;
class UUserWidget;
struct FDataRegistryAcquireResult;
struct FDaggerNotificationMessage;
...
struct FPendingAccoladeEntry
{
    ...
    FDaggerAccoladeDefinitionRow Row; 
...
class UDaggerAccoladeHostWidget : public UCommonUserWidget, public FAsyncMixin
{
    GENERATED_BODY()
...
private:
    ...
    void OnNotificationMessage(FGameplayTag Channel, const FDaggerNotificationMessage& Notification);
