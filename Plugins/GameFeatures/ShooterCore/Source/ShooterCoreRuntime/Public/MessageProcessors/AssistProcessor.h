...
private:
    void OnDamageMessage(FGameplayTag Channel, const FDaggerVerbMessage& Payload);
    void OnEliminationMessage(FGameplayTag Channel, const FDaggerVerbMessage& Payload);
