...
public:
    ...
    void GetVisibleTargets(const FAimAssistFilter& Filter, const FAimAssistSettings& Settings, const FAimAssistOwnerViewData& OwnerData, const TArray<FDaggerAimAssistTarget>& OldTargets, OUT TArray<FDaggerAimAssistTarget>& OutNewTargets);
...
protected:
    ...
    void DetermineTargetVisibility(FDaggerAimAssistTarget& Target, const FAimAssistSettings& Settings, const FAimAssistFilter& Filter, const FAimAssistOwnerViewData& OwnerData);
