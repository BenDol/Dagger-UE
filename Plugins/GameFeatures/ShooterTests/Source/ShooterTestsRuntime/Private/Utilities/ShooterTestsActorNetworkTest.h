...
struct ShooterTestsBaseActorNetworkTest : public TTest<Derived, AsserterType>
{
	...
	/** Setup the test by loading in the specified level and making sure that both the server and client Dagger players are fully spawned in before continuing. */
...
struct ShooterTestsActorAnimationNetworkTest : public ShooterTestsBaseActorNetworkTest<Derived, AsserterType, FShooterTestsActorInputTestHelper>
{
	...
	/**
	 * Perform an input on the server's Dagger character.
	 *
	...
	/**
	 * Perform an input on the client's Dagger character.
	 *
	 * @param Type - Type of input to be performed.
	 */
	...
	/** Stops any actively running inputs on the server's Dagger character. */
	...
	/** Stops any actively running inputs on the client's Dagger character. */
	...
	/** Check that the Dagger character representing the server player has the expected animation playing on all PIE sessions. */
	...
	/** Check that the Dagger character representing the client player has the expected animation playing on all PIE sessions. */
