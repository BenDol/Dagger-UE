...
/**
 * Input action to handle the Dagger player's crouch action.
 * 
...
/**
 * Input action to handle the Dagger player's melee action.
 *
...
/**
 * Input action to handle the Dagger player's jump action.
 *
...
/**
 * Base input action to handle the Dagger player's movement.
 *
...
/**
 * Base input action to handle the Dagger player's look (rotation).
 *
...
/** Movement input action to move the Dagger player forward. */
...
/** Movement input action to move the Dagger player backward. */
...
/** Movement input action to strafe the Dagger player to the left. */
...
/** Movement input action to strafe the Dagger player to the right. */
...
/** Rotation input action to rotate the Dagger player to the left. */
...
/** Rotation input action to rotate the Dagger player to the right. */
...
/**
 * Inherited InputTestAction used for testing our button and axis interactions for the Dagger player.
 * 
